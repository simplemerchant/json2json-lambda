...
TemplateConfig = (typeof require === "function" ? require('./TemplateConfig') : void 0) || (
  typeof window !== "undefined" && window !== null ? window.json2json.TemplateConfig : void 0
);
...
ObjectTemplate = (function() {
  ...
  ObjectTemplate.prototype.processRemaining = function(context, node) {
    ...
    for (key in node) {
      value = node[key];
      if (!this.pathAccessed(node, key) && indexOf.call(context, key) < 0 && this.config
